...
const deployMarketplaceContract = async (owner) => {
  console.log("Deploying Marketplace contract...");
  const MarketplaceFactory = new ethers.ContractFactory(marketplace_sol_json.default.abi, marketplace_sol_json.default.bytecode, owner);
...
const deployMyNFTContract = async (owner, marketplace_addr) => {
  console.log("Deploying MyNFT contract...");
  const MyNFTFactory = new ethers.ContractFactory(mynft_sol_json.default.abi, mynft_sol_json.default.bytecode, owner);
